        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tokeni = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gorivo = table.Column<string>(type: "TEXT", nullable: false),
                    Godiste = table.Column<int>(type: "INTEGER", nullable: false),
                    Model = table.Column<string>(type: "TEXT", nullable: false),
                    Kilometraza = table.Column<int>(type: "INTEGER", nullable: false),
                    Kubikaza = table.Column<double>(type: "REAL", nullable: false),
                    BrojVrata = table.Column<int>(type: "INTEGER", nullable: false),
                    SnagaMotora = table.Column<double>(type: "REAL", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AllCars_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_AllCars_CarId",
                        column: x => x.CarId,
                        principalTable: "AllCars",
                        principalColumn: "Id");
                });
